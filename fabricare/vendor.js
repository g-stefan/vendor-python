...
runInPath("archive", function () {
	webLink = "https://github.com/python/cpython/archive/refs/tags/v" + Project.version + ".zip";
	...
	Shell.rename("c" + Project.vendor, Project.vendor);

	webLink = "https://github.com/bjia56/portable-python-cmake-buildsystem/archive/refs/heads/master.zip";	
	if (!Shell.fileExists("python-cmake-buildsystem.zip")) {
		exitIf(Shell.system("curl --insecure --location " + webLink + " --output " + "python-cmake-buildsystem.zip"));
	};
	exitIf(Shell.system("7z x " + "python-cmake-buildsystem.zip" + " -aoa -o./"));
	Shell.removeFile("python-cmake-buildsystem.zip");
	exitIf(!Shell.copyDirRecursively("portable-python-cmake-buildsystem-portable-python", Project.vendor));
	...
	Shell.removeDirRecursively("portable-python-cmake-buildsystem-portable-python");	
});
